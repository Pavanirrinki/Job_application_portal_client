            ...
            return (
              ...
              >
                <Container className="d-flex justify-content-between align-items-start pt-3">
                  ...
                  />
                  <Typography>{data?.posted} ago</Typography>
                </Container>
                <div className="fs-15 fw-medium m-1">
  {data?.job_name ? (data.job_name.length > 25 ? `${data.job_name.substring(0, 25)}....` : data.job_name) : ''}
</div>
                ...
                <Container className="d-flex justify-content-between align-items-center">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <Typography className="fs-12">{data?.rating}</Typography>
                  </div>
                </Container>
                <div className="d-flex align-items-center">
